...
namespace OC.HiddenDashboard.Composers
{
    public class OCHiddenDashboardApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            // Register configuration options
            builder.Services.Configure<HiddenDashboardOptions>(
                builder.Config.GetSection("OC.HiddenDashboard"));
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "OCHidden Dashboard Backoffice API",
                    Version = "1.0",
                });

                // Enable Umbraco authentication for the "Example" Swagger document
                // PR: https://github.com/umbraco/Umbraco-CMS/pull/15699
                opt.OperationFilter<OCHiddenDashboardOperationSecurityFilter>();
            });
        }

        public class OCHiddenDashboardOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("OC.HiddenDashboard.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
