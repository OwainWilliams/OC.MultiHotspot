...
namespace OC.MultiHotspot.Composers
{
    public class MultiHotspotEditorApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "OC Multi Hotspot Editor Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<MultiHotspotEditorOperationSecurityFilter>();
            });
        }

        public class MultiHotspotEditorOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("OC.MultiHotspot.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
